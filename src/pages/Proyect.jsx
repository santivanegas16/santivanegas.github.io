        ...
        <div className='w-full min-h-screen md:w-[70%] bg-white flex flex-col items-center justify-center pt-[80px] pb-[50px]'>
          ...
          <div className='flex flex-col items-center md:flex-row  w-[70%] mt-5'>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-justify'>Development of a dynamic and responsive comic and manga website using MongoDB, Express.js, React.js, Node.js, Tailwind CSS and SCRUM methodology. Providing users with a wide variety of content to explore and enjoy.</p>
            </div>
          </div>
          ...
          <div className='flex flex-col items-center md:flex-row  w-[70%] mt-5'>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-justify'>Development of a dynamic and responsive website for a pet shop. Using HTML, CSS, JavaScript, Bootstrap and integrating the use of an API; which allows posting a new product to be automatically displayed in the catalog, also, a functional shopping cart, where you can add the products and buy them.</p>
            </div>
          </div>
          ...
          <div className='flex flex-col items-center md:flex-row w-[70%] mt-5'>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-justify'>Development of a website for an events company. Using HTML, CSS, JavaScript, SwiperJS and Bootstrap. Integrating the consumption of an API, to obtain data about the events; allowing to visualize in an optimal way the events presented and filtered.</p>
            </div>
          </div>
        </div>
